...
export const _userAbout = {
  ...
  quote:
    'Advanced trading algo system powered by real-time market data, smart indicators, and automated execution. Designed for high-frequency decision making, risk management, and consistent performance across volatile market conditions. Supports strategy backtesting, live order placement, and broker integration with full transparency and control.',
  socialLinks: {
