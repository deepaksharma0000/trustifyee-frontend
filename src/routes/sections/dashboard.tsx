...
const GroupServicePage = lazy(() => import('src/pages/dashboard/product/group-service')); // [NEW]
// ORDER
...
const UserStarPage = lazy(() => import('src/pages/dashboard/user/star'));
// BLOG
...
const RiskHealthPage = lazy(() => import('../../pages/dashboard/risk-health'));
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: ':id/review', element: <OverviewBankingPage /> },
          { path: 'account', element: <UserAccountPage /> },
          { path: 'star', element: <UserStarPage /> },
        ],
      },
      {
        path: 'product',
        children: [
          ...
          { path: 'group-service', element: <GroupServicePage /> }, // [NEW]
        ],
      },
      {
        path: 'order',
      ...
      { path: 'risk-health', element: <RiskHealthPage /> }, // [NEW]
